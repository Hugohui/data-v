...
export const sheepFeedLineOptions = (options: any) => {
  return {
    tooltip: {
      trigger: 'axis'
    },
    ...
    yAxis: [
      {
        ...
        name: 'kg',
        min: 0, // 设置纵坐标的最小值
        max: options.maxyAxis, // 设置纵坐标的最大值
        interval: Math.ceil(options.maxyAxis / 5), // 设置纵坐标的间隔
        axisLine: {
          show: false,
          lineStyle: {
            color: '#fff'
    ...
    series: [
      {
        data: options.MilkPowderSubstitute,
        type: 'line',
        name: "日饲喂量",
